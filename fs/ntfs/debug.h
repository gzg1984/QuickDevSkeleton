...
extern void __ntfs_error_attr(const char *function, const struct super_block *sb,ATTR_REC* attr);
#define ntfs_error_attr(sb, a)		__ntfs_error_attr(__func__, sb, a)
